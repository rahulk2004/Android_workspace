...
class FilterHtoLActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_filter_hto_lactivity)
        ...
        var stringRequest = StringRequest(
            Request.Method.GET,"https://prakrutitech.buzz/Rahul/filterdesc.php",
